...
proportion_sources_dfs = float(len(sources)/N)
f.write("Proportion of sources for G2 = %f" %proportion_sources_dfs)
f.close()
...
proportion_sinks_dfs = float(len(S)/N)
f.write("Proportion of sinks for G2 = %f" %proportion_sinks_dfs)
f.close()
